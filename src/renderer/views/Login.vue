 ...
 * @Last Modified time: 2023-03-08 06:53:14
 * @Description: 登陆页面
 */
<template>
    ...
    <div class="login-layer">
      ...
      <div class="i18-icon">
        <el-dropdown trigger="click" placement="bottom" @command="handleSetLanguage">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item v-for="item in $store.state.base.sysConfig.language"
              :disabled="$store.state.base.sysConfig.currLanguage === item.code" :command="item.code" :key="item.code">{{
      ...
      <div class="login-form">
        ...
        <ul class="login-body">
          ...
          <li>
            <input :placeholder="$t('login.passWord')" :type="showPw ? '' : 'password'" v-model="loginForm.passWd"
              maxlength="50" @keyup.enter="submitLoginForm" />
          ...
          <li class="captcha" v-if="$store.state.base.isShowCaptcha">
            ...
            <input :placeholder="$t('login.kaptchaCode')" v-model="loginForm.captcha" maxlength="4"
...
.login-page {
  ...
  .login-layer {
    ...
    .login-bg {
      ...
      background: -webkit-gradient(linear, to left, #437ce6 1%, #3bc3fb 99%);
      /* autoprefixer: ignore next */
      background: -webkit-linear-gradient(to left, #437ce6 1%, #3bc3fb 99%);
      /* autoprefixer: ignore next */
      background: -moz-linear-gradient(to left, #437ce6 1%, #3bc3fb 99%);
      /* autoprefixer: ignore next */
      background: -o-linear-gradient(to left, #437ce6 1%, #3bc3fb 99%);
      /* autoprefixer: ignore next */
      background: linear-gradient(to left, #437ce6 1%, #3bc3fb 99%);
