 ...
 * @Last Modified time: 2019-07-10 19:03:25
    ...
    <flex-item :grow='1' width='100%'>
      <el-card>
        ...
        <flex-container direction="column" wrap='nowrap'>
          ...
          <flex-item>
            <data-table ref="logQuartzTable" border index auto-load highlight-current-row auto-update column-button csv-button title="Data Table" :load-data-func='loadLogQuartz'>
              ...
              <data-table-column prop="procTime" label="耗时(ms)" width='75'></data-table-column>
              <data-table-column prop="execInfo" label="异常信息" show-overflow-tooltip></data-table-column>
