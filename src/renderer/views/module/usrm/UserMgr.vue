 ...
 * @Last Modified time: 2019-10-09 09:27:29
 * @Description: 用户管理
 */
<template>
    ...
    <flex-item :grow='1' width='100%'>
      <el-card>
        <flex-container slot="header" justifyContent='space-between'>
          ...
          <flex-item alignItems='center'>
            <el-button type="primary" size="mini" @click="handleAddUser" circle icon="el-icon-plus" title="添加"></el-button>
            <el-button type="primary" @click="handleQueryUser" size="mini" circle icon="el-icon-search" title="查询"></el-button>
              ...
              <el-row>
                ...
                <col-pr :xs='24' :sm='24' :md='12' :lg='12' :xl='6'>
                  <el-form-item label="最后登录 :" prop="lastLogDate">
                    <el-date-picker v-model="lastLogDate" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
                    </el-date-picker>
                  </el-form-item>
                </col-pr>
              </el-row>
